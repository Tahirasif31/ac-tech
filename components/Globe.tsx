...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center py-10 justify-center md:py-20 h-auto bg-black relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-[26rem] md:h-[40rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
